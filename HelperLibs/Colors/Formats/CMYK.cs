...
namespace WinkingCat.HelperLibs
{
    public struct CMYK
    {
        ...
        private CMYK(byte R, byte G, byte B, byte A = 255)
        {
            if (R == 0 && G == 0 && B == 0)
            {
                c = 0;
        ...
        /// <summary>
        /// Creates a new CMYK color from the given CMYK values.
        /// <para>Where C is a value from 0 - 100</para>
        /// <para>Where M is a value from 0 - 100</para>
        /// <para>Where Y is a value from 0 - 100</para>
        /// <para>Where K is a value from 0 - 100</para>
        /// </summary>
        /// <param name="C">A value from 0 - 1f</param>
        /// <param name="M">A value from 0 - 1f</param>
        /// <param name="Y">A value from 0 - 1f</param>
        /// <param name="K">A value from 0 - 1f</param>
        /// <returns>A CMYK color struct.</returns>
        public static CMYK FromCMYK100(float C, float M, float Y, float K)
        {
        ...
        /// <summary>
        /// Creates a new CMYK color from the given CMYK values.
        /// <para>Where C is a value from 0 - 1f</para>
        /// <para>Where M is a value from 0 - 1f</para>
        /// <para>Where Y is a value from 0 - 1f</para>
        /// <para>Where K is a value from 0 - 1f</para>
        /// </summary>
        /// <param name="C">A value from 0 - 1f</param>
        /// <param name="M">A value from 0 - 1f</param>
        /// <param name="Y">A value from 0 - 1f</param>
        /// <param name="K">A value from 0 - 1f</param>
        /// <returns>A CMYK color struct.</returns>
        public static CMYK FromCMYK0(float C, float M, float Y, float K)
        {
            return new CMYK(C * 100f, M * 100f, Y * 100f, K * 100f);
        }
        ...
        /// <param name="A">a value from 0 - 255</param>
        /// <returns>An CMYK color struct.</returns>
        public static CMYK FromARGB(int A, int R, int G, int B)
        {
            return new CMYK(Color.FromArgb(A, R, G, B));
        }
        ...
        /// <param name="B">a value from 0 - 255</param>
        /// <returns>An CMYK color struct.</returns>
        public static CMYK FromARGB(int R, int G, int B)
        {
            return new CMYK(Color.FromArgb(255, R, G, B));
        }
