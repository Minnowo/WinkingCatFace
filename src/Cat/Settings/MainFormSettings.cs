...
namespace WinkingCat.Settings
{
    ...
    public class MainFormSettings
    {
        ...
        public Color imageDisplayBG1 { get; set; } = Controls.ImageDisplay.DefaultCellColor1;

        [XmlIgnore]
        [DisplayName("Image Display Back Color 2")]
        [Editor(typeof(ColorEditor), typeof(UITypeEditor)), TypeConverter(typeof(_ColorConverter))]
        public Color imageDisplayBG2 { get; set; } = Controls.ImageDisplay.DefaultCellColor2;
