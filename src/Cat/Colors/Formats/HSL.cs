...
namespace WinkingCat.HelperLibs
{
    public struct HSL
    {
        ...
        {
            Hue360 = H.Clamp(0, 360);
            Saturation100 = S.Clamp(0, 100);
            Lightness100 = L.Clamp(0, 100);
            this.A = (byte)A;
        }
        ...
        public static HSL FromHSL360(float H, float S, float L, int A = 255)
        {
        ...
        /// <param name="A">A value from 0 - 255</param>
        /// <returns>An HSB color struct.</returns>
        public static HSL FromHSL0(float H, float S, float L, int A = 255)
        {
            return new HSL(H * 360f, S * 100f, L * 100f, A);
        }
        ...
        {
            return new HSL(Color.FromArgb(A, R, G, B));
        }
        ...
        {
            return new HSL(Color.FromArgb(255, R, G, B));
        }
